...
const WHALE = "0xbabe61887f1de2713c6f97e567623453d3C79f67";
...
describe("Mainnet Convex crvUSD-USDC", () => {
  ...
  let vault: VaultV1;
  let strategy: ConvexStrategyMainnet_crvUSD_USDC;
  ...
  beforeEach(async () => {
    ...
    const {
    ...
    } = await setUpCoreProtocol(
      {
        ...
        strategyType: "convex-crvusd-usdc",
      },
      governance
    );
    controller = controllerContract;
    vault = vaultContract;
    strategy = strategyContract as ConvexStrategyMainnet_crvUSD_USDC;
  });
